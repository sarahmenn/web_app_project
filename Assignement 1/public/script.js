...
//Assigment 1 : 
// allow to save the image with the right click on the same window

var img = document.createElement("img");
function SaveImageRightclick(){
    var dataURL = canvas.toDataURL("image/png");
    image.src = dataURL;
    document.body.appendChild(image);}

/* OU 
// open a window but don't show the image (only give the link to see the image) 
